...
struct PsychologistProfile: Identifiable, Codable, Hashable {
    let id: UUID
    let userId: UUID
...
enum Specialization: String, CaseIterable, Codable {
...
struct AvailableHour: Identifiable, Codable, Hashable {
    let id: UUID
