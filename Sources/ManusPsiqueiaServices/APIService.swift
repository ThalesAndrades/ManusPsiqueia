...
// Stripe Models
public struct StripePaymentIntentRequest: Codable {
    let amount: Int
    let currency: String
...
public struct StripeAutomaticPaymentMethods: Codable {
    let enabled: Bool
}
...
public struct StripeSubscriptionResponse: Codable {
...
// Supabase Models
public struct SupabaseResponse: Codable {
    let id: String?
...
// Diary Models
public struct DiaryInsight: Codable {
    let text: String
