...
public enum FinancialPeriod: String, CaseIterable, Codable {
    case week = "week"
    case month = "month"
...
public struct RevenueChartPoint: Identifiable, Codable {
    let id = UUID()
    let month: String
    let revenue: Double
    let date: Date
...
public struct PatientPayment: Identifiable, Codable {
    let id: UUID
    let patientId: UUID
...
// MARK: - Withdrawal
public struct Withdrawal: Identifiable, Codable {
    let id: UUID
    let amount: Decimal
...
public enum AnalyticsPeriod: String, CaseIterable, Codable {
    case day = "day"
    case week = "week"
    case month = "month"
    case quarter = "quarter"
