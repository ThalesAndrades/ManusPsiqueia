...
public struct CustomPlan: Identifiable, Codable {
    let id = UUID()
...
public struct PlanFeature: Identifiable, Codable, Hashable {
    let id = UUID()
    let name: String
...
@MainActor
public class DynamicPricingCalculator: ObservableObject {
