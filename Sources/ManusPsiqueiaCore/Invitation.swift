...
public struct PatientPsychologistLink: Identifiable, Codable, Hashable {
    let id: UUID
    let patientId: UUID
...
public struct InvitationTemplate {
...
public struct InvitationAnalytics: Codable {
...
public struct PatientInvitationStats: Identifiable, Codable {
    let id: UUID
    let patientId: UUID
    let patientName: String
    let totalInvitationsSent: Int
...
public struct InvitationNotification: Identifiable, Codable {
    let id: UUID
