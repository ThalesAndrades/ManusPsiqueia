...
public enum PaymentMethodType: String, CaseIterable, Codable {
    case card = "card"
    case pix = "pix"
    case boleto = "boleto"
...
public struct PatientPayment: Identifiable, Codable, Hashable {
    let id: UUID
    let patientId: UUID
...
public struct StripePaymentMethod: Identifiable, Codable, Hashable {
    let id: String
...
public struct PaymentIntent: Identifiable, Codable {
    let id: String
...
public struct StripeSubscription: Identifiable, Codable {
    let id: String
    let customerId: String
...
public struct PaymentConfiguration: Codable {
