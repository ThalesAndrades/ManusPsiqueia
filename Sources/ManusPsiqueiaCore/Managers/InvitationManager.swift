...
@MainActor
public class InvitationManager: ObservableObject {
...
public struct InvitationListResponse: Codable {
...
public struct PatientLinksResponse: Codable {
    let links: [PatientPsychologistLink]
    let total: Int
}

public struct PatientLinkResponse: Codable {
    let link: PatientPsychologistLink
}

public struct InvitationAnalyticsResponse: Codable {
