...
@MainActor
public class AutoUpgradeManager: ObservableObject {
...
public enum UpgradeType: String, CaseIterable {
...
public enum UpgradeUrgency: Int, CaseIterable {
    case low = 1
    case medium = 2
    case high = 3
    case critical = 4
...
public struct UpgradeAnalytics {
