...
public struct PatientPaymentRow: View {
...
public struct WithdrawalRow: View {
...
public struct WithdrawalStatusBadge: View {
...
public struct EmptyPaymentsView: View {
    var body: some View {
        VStack(spacing: 12) {
...
public struct EmptyWithdrawalsView: View {
    var body: some View {
        VStack(spacing: 12) {
...
public struct EmptyTransactionsView: View {
    var body: some View {
        VStack(spacing: 12) {
...
public struct FinancialBackgroundView: View {
...
public struct FinancialParticlesView: View {
...
public struct FinancialParticle: Identifiable {
    let id = UUID()
    let x: CGFloat
    let y: CGFloat
    let size: CGFloat
