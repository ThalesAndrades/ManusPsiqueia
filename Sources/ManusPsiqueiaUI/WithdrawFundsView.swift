...
public struct WithdrawFundsView: View {
...
public struct QuickAmountButton: View {
    let amount: Int
...
public struct BankAccountRow: View {
...
public struct EmptyBankAccountsView: View {
...
public struct WithdrawBackgroundView: View {
...
public struct WithdrawParticlesView: View {
...
public struct WithdrawParticle: Identifiable {
    let id = UUID()
    let x: CGFloat
    let y: CGFloat
    let size: CGFloat
...
public struct AddBankAccountView: View {
    @EnvironmentObject var stripeManager: StripeManager
    @Environment(\.dismiss) private var dismiss
